...
export function DataTableRowActions({ row }: { row: Row<NewsCategory> }) {
    const handleDelete = (id: number) => {
        router.delete(route('super-admin.news-categories.destroy', { id }), {
            onSuccess: () => {
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-[260px]">
                    <Link href={route('super-admin.news-categories.edit', { id: row.original.id })} className="cursor-pointer">
