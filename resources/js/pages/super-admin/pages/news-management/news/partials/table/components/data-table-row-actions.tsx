...
export function DataTableRowActions({ row }: { row: Row<News> }) {
    const handleDelete = (id: number) => {
        router.delete(route('super-admin.news.destroy', { id }), {
            onSuccess: () => {
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-[260px]">
                    <Link href={route('super-admin.news.edit', { id: row.original.id })} className="cursor-pointer">
