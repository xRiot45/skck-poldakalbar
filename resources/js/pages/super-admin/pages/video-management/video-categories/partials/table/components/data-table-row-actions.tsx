...
export function DataTableRowActions({ row }: { row: Row<VideoCategory> }) {
    const handleDelete = (id: number) => {
        router.delete(route('super-admin.video-categories.destroy', { id }), {
            onSuccess: () => {
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-[260px]">
                    <Link href={route('super-admin.video-categories.edit', { id: row.original.id })} className="cursor-pointer">
