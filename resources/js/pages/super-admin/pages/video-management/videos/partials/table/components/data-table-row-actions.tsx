...
export function DataTableRowActions({ row }: { row: Row<Video> }) {
    const handleDelete = (id: number) => {
        router.delete(route('super-admin.videos.destroy', { id }), {
            onSuccess: () => {
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-[260px]">
                    <Link href={route('super-admin.videos.edit', { id: row.original.id })} className="cursor-pointer">
