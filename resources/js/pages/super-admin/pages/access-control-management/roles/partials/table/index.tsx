...
export default function RoleTable({ columns, data }: DataTableProps<Role>) {
                                    ...
                                    {headerGroup.headers.map((header) => {
                                        return (
                                            <TableHead
                                                ...
                                                className={(header.column.columnDef.meta && 'className' in header.column.columnDef.meta ? (header.column.columnDef.meta as { className?: string }).className : '')}
                                            >
