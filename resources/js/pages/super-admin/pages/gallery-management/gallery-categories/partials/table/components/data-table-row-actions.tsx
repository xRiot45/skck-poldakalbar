...
export function DataTableRowActions({ row }: { row: Row<GalleryCategory> }) {
    const handleDelete = (id: number) => {
        router.delete(route('super-admin.gallery-categories.destroy', { id }), {
            onSuccess: () => {
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-[260px]">
                    <Link href={route('super-admin.gallery-categories.edit', { id: row.original.id })} className="cursor-pointer">
