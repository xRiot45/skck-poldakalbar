...
export function DataTableRowActions({ row }: { row: Row<OrganizationalFunction> }) {
    const handleDelete = (id: number) => {
        router.delete(route('super-admin.organizational-function.destroy', { id }), {
            onSuccess: () => {
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-[260px]">
                    <Link href={route('super-admin.organizational-function.edit', { id: row.original.id })} className="cursor-pointer">
